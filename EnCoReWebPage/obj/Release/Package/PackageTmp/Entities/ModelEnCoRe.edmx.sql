...
-- --------------------------------------------------
-- Date Created: 08/04/2020 16:37:55
-- Generated from EDMX file: C:\Users\Owner\Desktop\EnCoReWebPage\EnCoReWebPage\EnCoReWebPage\Entities\ModelEnCoRe.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[DB_BlogEnCoReModelStoreContainer].[PasswordRequest]', 'U') IS NOT NULL
    DROP TABLE [DB_BlogEnCoReModelStoreContainer].[PasswordRequest];
GO
